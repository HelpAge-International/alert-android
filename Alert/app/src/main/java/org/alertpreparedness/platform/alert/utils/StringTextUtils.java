...
public class StringTextUtils {
    private static final String TAG = "StringTextUtils";
    ...
    private StringTextUtils() { /* cannot be instantiated */ }
     ...
     * <pre>
     * // Once
     * StringTextUtils.StringSplitter splitter = new StringTextUtils.SimpleStringSplitter(delimiter);
     *
    ...
    implements CharSequence, GetChars
    {
        ...
        public void getChars(int start, int end, char[] dest, int destoff) {
            StringTextUtils.getChars(mSource, start + mStart, end + mStart,
                               dest, destoff);
